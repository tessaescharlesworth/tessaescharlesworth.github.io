...
$sql1="SELECT DATE_FORMAT(date,'%Y-%m') AS date, AVG($q2) FROM $q1 WHERE $q3 = 'American Indian or Alaska Native' GROUP BY MONTH(date),YEAR(date)";
...
// Asian
$sql2="SELECT DATE_FORMAT(date,'%Y-%m') AS date, AVG($q2) FROM $q1 WHERE $q3 = 'Asian' GROUP BY MONTH(date),YEAR(date)";
...
$sql3="SELECT DATE_FORMAT(date,'%Y-%m') AS date, AVG($q2) FROM $q1 WHERE $q3 = 'Black or African American' GROUP BY MONTH(date),YEAR(date)";
...
// White 
$sql4="SELECT DATE_FORMAT(date,'%Y-%m') AS date, AVG($q2) FROM $q1 WHERE $q3 = 'White' GROUP BY MONTH(date),YEAR(date)";
...
$sql5="SELECT DATE_FORMAT(date,'%Y-%m') AS date, AVG($q2) FROM $q1 WHERE $q3 = 'More than one race Black or White' GROUP BY MONTH(date),YEAR(date)";
...
$sql6="SELECT DATE_FORMAT(date,'%Y-%m') AS date, AVG($q2) FROM $q1 WHERE $q3 = 'More than one race Other' GROUP BY MONTH(date),YEAR(date)";
...
// Other or Unknown
$sql7="SELECT DATE_FORMAT(date,'%Y-%m') AS date, AVG($q2) FROM $q1 WHERE $q3 = 'Other or Unknown' GROUP BY MONTH(date),YEAR(date)";
...
$('#chart-E').appendTo('#container').highcharts({
        ...
        borderWidth: 1
                    ...
                    series: [
                        {
                            name: 'More than one race - Black/White',
                            color: '#24CBE5',
